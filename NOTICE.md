...
- Three.js — MIT
- Marcellus — SIL Open Font License 1.1
- Manrope — SIL Open Font License 1.1
- IBM Plex Mono — SIL Open Font License 1.1

The Hara social artwork displayed on the Hara project page is served from the
Hara project website and remains subject to the Hara project's notices.
